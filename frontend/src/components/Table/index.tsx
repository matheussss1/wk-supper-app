...
export function TableHeader({ children, ...props }: TableHTMLAttributes<HTMLTableCellElement>) {
    return <th className={styles.tableHeader} {...props}>{children}</th>

}

export function TableRow({ children, ...props }: TableHTMLAttributes<HTMLTableRowElement>) {
    return <tr className={styles.tableRow} {...props}>{children}</tr>
}


export function TableCell({ children, ...props }: TableHTMLAttributes<HTMLTableCellElement>) {
